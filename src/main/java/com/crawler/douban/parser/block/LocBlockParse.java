...
import com.crawler.douban.entry.builder.block.LocBlockBuilder;
 ...
 */
@BlockType("loc")
public class LocBlockParse implements BlockParseService {

    @Override
    public Block parse(Optional<Element> blockSubject) {
        LocBlockBuilder blockBuilder = new LocBlockBuilder();
